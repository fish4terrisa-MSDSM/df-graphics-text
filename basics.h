...
enum AnnouncementType
{
	...
	ANNOUNCEMENT_PUT_ON_ITEM,
	ANNOUNCEMENT_TAKE_OFF_ITEM,
	ANNOUNCEMENT_DEITY_PRONOUNCEMENT,
	ANNOUNCEMENT_CREATURE_STUCK,
	ANNOUNCEMENT_CITIZEN_STUCK,
